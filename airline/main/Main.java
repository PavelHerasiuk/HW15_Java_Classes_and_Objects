...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        flightSchedule.addAirline("Berlin (SXF)", "B2 891", "Airbus 320",
        ...
        flightSchedule.addAirline("Moscow (SVO)", " AX A01", "Airbus 380",
        ...
        flightSchedule.addAirline("Brussels (CRL)", "B2 817", "Airbus 350",
        ...
        flightSchedule.addAirline("Paris (CDG)", "B2 863", "Airbus 380",
